    ...
    if age is not None:
        ...
        if age < 0 or age > 65:
            return build_validation_result(
                False,
                "age",
                "You should be between 0 and 65 age to use this service, "
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                ...
                "please provide a correct investable amount.",
            )
    
    # Validate if a correct riskLevel was input
    if risk_level is not None:
        if risk_level.upper() not in ["NONE", "LOW", "MEDIUM", "HIGH"]:
            return build_validation_result(
                False,
                "riskLevel",
                "Sorry, you need to input appropriate risk level such as - None, Low, Medium, High",
            )
    
    # A True results is returned if age or amount or risk level are valid
...
def recommend_portfolio(intent_request):
    ...
    if risk_level == "NONE":
        bond_amount = investment_amount*1
        equity_amount = investment_amount*0
    elif risk_level == "LOW":
        bond_amount = investment_amount*0.6
        equity_amount = investment_amount*0.4
    elif risk_level == "MEDIUM":
        bond_amount = investment_amount*0.4
        equity_amount = investment_amount*0.6
    else:
        bond_amount = investment_amount*0.2
        equity_amount = investment_amount*0.8
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            Based on your profile, and most importantly your {} risk intent, your investment portfolio should be: ${} bonds (AGG) and ${} equities (SPY)
            """.format(
                risk_level, bond_amount, equity_amount
            ),
        },
    )
